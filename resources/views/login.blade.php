        ...
        <div
            ...
            <div class="text-white flex xl:my-20 xl:mx-12 2l:my-20 2l:mx-12 lg:my-20 lg:mx-12 my-10 mx-10">
                <div class="xl:w-[516px] space-y-4">
                    ...
                    <p class="text-[14px]">At Telemedicine, we bring you closer to the people who matter most with our
                        high-quality video and audio technology. Connect instantly with our user-friendly interface and
                        enjoy secure, private conversations.</p>
                    ...
                    <p class="text-[14px]">Sign up now to experience the future of video commmunication. Whether for
                        personal use or business, Telemedicine is your go-to solution for seamless, high-quality video
                        chats.</p>
                    <h2 class="text-[20px]">Get Started</h2>
                    <p class="text-[14px]">Create your free account and explore Telemedicine's features. Welcome to the
                        new era of video communication!</p>
                </div>
            </div>
            <div class="xl:w-[577px] 2xl:w-[577px] lg:w-[577px] bg-[#080D14] flex xl:py-20 px-4 pb-10 w-full">
                <form method="post" class="w-full" action="{{ route('login') }}">
                    ...
                    <div class="mx-auto text-white flex-col flex">
                        <h1 class="2xl:text-[28px] xl:text-[28px] lg:text-[28px] text-[20px] font-semibold">Telemedicine
                        </h1>
                        ...
                        <button type="submit"
                            class="my-4 bg-[#487D27] lg:w-[470px] xl:w-[470px] 2xl:w-[470px]  h-[60px] text-[16px] rounded px-4 font-semibold  hover:bg-[#287D27]">
                            Login</button>
                        <div>
                            <span class="text-[14px] mx-2">If you don’t have an account you can
                                <a href="/register" class="hover:underline text-[#F87979] mx-2">Sign-up</a>for free
                            </span>
                        </div>
                    </div>
                </form>
